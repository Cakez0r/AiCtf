namespace AiCtf.Sdk
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        /// <summary>
        /// Initialise a Vector2 from polar co-ordinates
        /// </summary>
        /// <param name="length">The length of the vector</param>
        /// <param name="theta">The angle of the vector (in radians)</param>
        /// <returns></returns>
        public static Vector2 FromPolar(float length, float theta)
        {
